    ...
    <form name="formu-acceso" action="controller/login.controller.php" method="post">
        ...
        <div class="input-group mb-3">
            <div class="form-floating">
                <input type="text" class="form-control focus-ring focus-ring-danger border" id="user" placeholder="Usuario" name="user" autocomplete="off" required>
        ...
        <div class="input-group mb-3">
            <div class="form-floating">
                <input type="password" class="form-control focus-ring focus-ring-danger border" id="password" placeholder="Contraseña" name="password"
        ...
        <input type="submit" value="Entrar" class="btn btn-danger w-100">
